...
<head>
    ...
    <title>Tình hình dịch Covid19</title>
...
<body style="background:url('Images/Big_images/COVID-19_background.jpg');background-attachment: fixed;background-position:center;background-repeat:no-repeat;background-size:cover;">
...
<div class="menu-covid">
    <ul>
        <li><a href="?option=tintuc"><i class="far fa-newspaper"></i>&nbsp;Tin tức</a></li>
        <li><a href="?option=covid19-in-VietNam"><i class="fas fa-user-nurse"></i>&nbsp;Số liệu Việt Nam</a></li>
        <li><a href="?option=covid19-in-world"><i class="fas fa-globe-americas"></i>&nbsp;Số liệu thế giới</a></li>
    </ul>
</div>
...
<?php 
   if(isset($_GET['option'])){
       switch($_GET['option']){
           case 'covid19-in-VietNam':{
               include "Views/covid19_VietNam.php";
               break;
           }
          case 'covid19-in-world':{
                include "Views/covid19_World.php";
                break;
          } 
          case 'tintuc':{
