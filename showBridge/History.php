...
<?php
  $query11="SELECT * FROM bridges_posts where BHistoryPost not like ' ' order by RAND()  Limit 8";
...
background-repeat:no-repeat;background-size:cover;">
 <div>
    ...
    <div class='FixedDesign'>
      ...
      <div class="Footer" id="showFooter"  style="margin-top:1600px;position:relative;z-index:1000">
