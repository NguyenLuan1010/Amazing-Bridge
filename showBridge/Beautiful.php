...
<?php
  $query11="SELECT * FROM bridges_posts where BHeadPost like '%đẹp%' order by RAND()  Limit 8";
...
background-repeat:no-repeat;background-size:cover;">
 <div class="header-box">
    ...
    <div class='FixedDesign'>
        <h2>Những cây cầu đẹp nhất thê giới</h2>
        <p>Đây là những tác phẩm nghệ thuật hoàn hảo do sự sáng tạo của con người làm ra</p>
        <p>Những chiếc cầu cùng với vẻ đẹp mang tầm thế giới chắc chắn sẽ làm bạn cảm thấy thú vị</p>
