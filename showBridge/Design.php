...
<?php 
  $query34="SELECT * FROM bridges_posts  where BBridgeDesign like '%thiết kế độc đáo%' order by RAND() Limit 8";
...
<body style="background-image:url('../Images/Big_images/Kerch Bridge.jpg');background-attachment: fixed;background-position:center;
...
<div class="header-box">
    ...
    <div class='FixedDesign'>
        ...
        <p>Giới thiệu những cây cầu có những thiết kế mang tính biểu tượng</p>
        <p>Cùng những thông tin hữu ích giúp bạn có cái nhìn khách quan hơn</p>
    </div>
