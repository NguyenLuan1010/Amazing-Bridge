...
<?php
  $query11="SELECT * FROM bridges_posts where BHeadPost like '%nguy hiểm%' or BBridgeDesign like '%nguy hiểm%'
  or BHistoryPost like '%nguy hiểm%' order by RAND()  Limit 8";
...
<head>
    ...
    <title>Nguy hiểm nhất thê gới</title>
...
<div class="header-box">
    ...
    <div class='FixedDesign'>
        <h2>Những cây cầu nguy hiểm nhất thế giới</h2>
        <p>Giành cho những người thích khám phá mạo hiểm hoặc là những tai nạn thường xảy ra</p>
        <p>Những chiếc cầu cùng với câu chuyện phía sau chắc chắn sẽ làm bạn cảm thấy thú vị</p>
