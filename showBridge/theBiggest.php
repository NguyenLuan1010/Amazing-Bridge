...
<?php
 $query="SELECT * FROM bridges_posts where BHeadPost like '%cao nhất%' or BBridgeDesign like '%cao nhất%'
 or BHistoryPost like '%cao nhất%' order by RAND()  Limit 8";
...
<div class="header-box">
    ...
    <div class='FixedDesign'>
        <h2>Những cây cầu cao nhất thế giới</h2>
        <p>Cây cầu mang được đầu tư hoành tráng sẽ khiến bạn phải choáng ngợp khi chiêm ngưỡng nó</p>
    </div>
