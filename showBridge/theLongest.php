...
<?php
   $query14="SELECT * FROM bridges_posts where BHeadPost like '%dài nhất%' order by RAND() Limit 8 ";
...
<body style="background-image:url('../Images/Normal_images/Brooklyn Bridge.jpg');background-attachment: fixed;background-position:center;
...
<div class="header-box">
    ...
    <div class='FixedDesign'>
        <h2>Dài nhất thế giới cũng là một cách để miêu tả những cây cầu này</h2>
        <p>Mang tới cho bạn những kiến trúc rất quy mô và hoành tráng</p>
        <p>Những chiếc cầu cùng với cách thiết kế sẽ tạo cho bạn cảm giác thú vị </p>
