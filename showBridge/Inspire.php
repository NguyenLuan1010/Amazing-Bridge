...
<?php 
$query29="SELECT * FROM bridges_posts where BHeadPost like '%sáng tạo%' or BBridgeDesign like '%sáng tạo%'
or BHistoryPost like '%sáng tạo%' order by RAND()  Limit 8";
$result29=$connect->query($query29);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="background-image:url('../Images/Big_images/the Forth Bridge.jpg');background-attachment: fixed;background-position:center;
background-repeat:no-repeat;background-size:cover;">
 <div class="header-box">
    ...
    <div class='FixedDesign'>
        <h2>Cảm hứng sáng tạo</h2>
        <p>Không chỉ là những cây cầu đơn thuần, bình thường</p>
        <p>Mà đó còn là những sáng tạo,là nghệ thuật được con người "thổi" vào</p>
    </div>
         <div  class="DesignBox" style="width:55%;height:1330px;margin-left:40%;margin-top:150px;float:left">
         <?php foreach($result29 as $item):?>
