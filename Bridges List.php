...
<?php
  $query="SELECT Distinct * FROM bridges_posts  ";
  $page=1;
  if(isset($_GET['page'])){
      $page=$_GET['page'];
  }
...
<div class="header-box">
      ...
      <section class="under-header-menu">
        ...
        <div class="headNewBridge">
            <img src="Images/Big_images/the Forth Bridge.jpg" alt="">
            <div class="insideHeadNew">
                <b>Chào mừng đến với Amazing Bridge</b><br>
            </div>
        </div>
        <div class="insideHeadBox">
        <?php foreach($result as $item):?>
            <a href="ConceptBridges.php?BPostID=<?=$item['BPostID']?>" class="insideListBox">
                <img src="Images/Big_images/<?=$item['BBigImages']?>" alt="">
                <div class="doubleInsideList"><br><h2>&emsp;<?=$item['BTitle']?></h2><br><br><br></div>
                <div class="doubleInsideBox"><p><?=$item['BHeadPost']?></p></div>
             </a>
         <?php endforeach;?>
         <div class="pages">
            <?php for($i=1; $i<=$totalPage;$i++):?>
                <a href="?page=<?=$i?>"><?=$i?></a>&emsp;&emsp;
                <?php endfor;?>
        </div>
        </div>
      <br><br><br><br>
